...
public class NMapPOIflagType {
	...
	public static final int BUS = SINGLE_POI_BASE;
	public static final int KIDS = SINGLE_POI_BASE+1;
	public static final int IC1 = SINGLE_POI_BASE+2;
	public static final int IC2 = SINGLE_POI_BASE+3;
	public static final int IC3 = SINGLE_POI_BASE+4;
	public static final int IC4 = SINGLE_POI_BASE+5;
	public static final int IC5 = SINGLE_POI_BASE+6;
	public static final int ARR = SINGLE_POI_BASE+7;
